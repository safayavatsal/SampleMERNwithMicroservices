...
Deploying a MERN (MongoDB, Express.js, React, Node.js) application using Google Kubernetes Service (AKS) involves several steps.

## Prerequisites
1. Google Account: Ensure you have an Google account.
...
docker tag simple_mearn_be_micro_1 safayavatsal/simple_mearn_be_micro_1:latest
docker tag simple_mearn_be_micro_2 safayavatsal/simple_mearn_be_micro_2:latest
docker tag simple_mern_micro_fe safayavatsal/simple_mern_micro_fe:latest

docker push safayavatsal/simple_mearn_be_micro_1:latest
docker push safayavatsal/simple_mearn_be_micro_2:latest
docker push safayavatsal/simple_mern_micro_fe:latest
...
gcloud container clusters delete mern-micro-cluster --zone <zone> --quiet
